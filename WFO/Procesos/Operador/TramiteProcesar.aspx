...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="lblSendToMesaTitle">Enviar a Mesa</h4>
                </div>
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSendToMesa" ValidationGroup="EnvioMesas" runat="server" Text="Enviar a Mesa" class="btn btn-success" OnClick="btnSendToMesa_Click" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_btnSendToMesa');" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                    <div class="row text-center">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Aceptar" class="btn btn-primary col-md-5 col-sm-5 col-xs-12" CausesValidation="False" OnClick="btnAceptar_Click" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_Button1');" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade confirmacion" id="ContinuarFusionarExpediente" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title" id="myModalLabel2">
                        <asp:label ID="Label84" runat="server" Text="Confirmación de movimiento">
                        </asp:label>
                    </h4>
                </div>
                <div class="modal-body text-center">
                    <h5 class="modal-title" id="myModalLabel2">
                        <asp:Label runat="server" ID="Label85" Text="¿ Deseas fusionar los archivos al expediente ?"></asp:Label>
                    </h5>
                </div>
                <div class="modal-footer text-center">
                    <div class="row text-center">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                    <div class="row text-center">
                        <button type="button" class="btn btn-default col-md-6 col-sm-6 col-xs-12" data-dismiss="modal">Cancelar</button>
                        <asp:Button ID="Button3" runat="server" Text="Aceptar" class="btn btn-primary col-md-5 col-sm-5 col-xs-12" CausesValidation="False" OnClick="btnPCI_Click" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_Button3');" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade confirmacionRevionMedica" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title" id="confirmacionRevionMedicaTitle">
                        <asp:label ID="Label82" runat="server" Text="Confirmación de movimiento">
                        </asp:label>
                    </h4>
                </div>
                <div class="modal-body text-center">
                    <h5 class="modal-title" id="confirmacionRevionMedicaQuestion">
                        <asp:Label runat="server" ID="Label83" Text="¿ Deseas mandar tramite a Revision Médica ?"></asp:Label>
                    </h5>
                </div>
                <div class="modal-footer text-center">
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                        <button type="button" class="btn btn-default col-md-6 col-sm-6 col-xs-6" data-dismiss="modal">Cancelar</button>
                        <asp:Button ID="btnSeleccionEnviarRevionMedica" runat="server" Text="Aceptar" class="btn btn-primary col-md-5 col-sm-5 col-xs-6" CausesValidation="False" OnClick="btnSeleccionEnviarRevionMedica_Clic" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_btnSeleccionEnviarRevionMedica');" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade confirmacionSeleccionCompleta" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title" id="confirmacionSeleccionCompletaTitle">
                        <asp:label ID="lblTituloSeleccionCompleta" runat="server" Text="Confirmación de movimiento">
                        </asp:label>
                    </h4>
                </div>
                <div class="modal-body text-center">
                    <h5 class="modal-title" id="confirmacionSeleccionCompletaQuestion">
                        <asp:Label runat="server" ID="lblTituloSeleccionCompletaConfirma" Text="¿ Deseas mandar tramite a selección ?"></asp:Label>
                    </h5>
                </div>
                <div class="modal-footer text-center">
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                        <button type="button" class="btn btn-default col-md-6 col-sm-6 col-xs-6" data-dismiss="modal">Cancelar</button>
                        <asp:Button ID="btnAceptarSeleccionCompleta" runat="server" Text="Aceptar" class="btn btn-primary col-md-5 col-sm-5 col-xs-6" CausesValidation="False" OnClick="btnAceptarSeleccionCompleta_Click" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_btnAceptarSeleccionCompleta');"/>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <table class="table table-hover table-bordered">
                                <thead>
                                    ...
                                    <asp:Panel runat="server" ID="tituloProducto" Visible="true"> 
                                        <tr>
                                            <th colspan="2" style="text-align:center; border-bottom: 1px solid #ddd; background-color:#EADB20; color:black;">
                                                <asp:Label runat="server" ID="LabelNumeroPoliza" Text="-" Font-Bold="false" class="control-label"></asp:Label>
                                                <asp:Label runat="server" ID="LabelNumeroPoliza2" Text="-" Font-Bold="true" class="control-label"></asp:Label>
                                            </th>
                                        </tr>
                                        <tr>
                    ...
                    <div class="row">
                        ...
                        <asp:UpdatePanel ID="PolizaSisLegados" runat="server" Visible="false" UpdateMode="Conditional" >
                            <ContentTemplate>
                               <div class="row control-label col-md-4 col-sm-4 col-xs-12 text-center">
                                    <asp:Label runat="server" ID="label1" Text="Número de póliza" Font-Bold="True" class="control-label"></asp:Label>
                        ...
                        <div class="control-label col-md-7 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <asp:Button ID="btnRevionMedica" Visible="false"  runat="server" Text="Rev Medica" class="btn btn-dark col-md-2 col-sm-2 col-xs-12" data-toggle="modal" data-target=".confirmacionRevionMedica"/>
                        ...
                        <div class="x_content text-left">
                            ...
                            <div class="row">
                                <div class=" profile_details">
                                    <div class="col-md-6 col-sm-6 col-xs-12 well profile_view" style="display: none;">
                                        ...
                                        <div class="right col-xs-12 text-left">
                                           ...
                                           <br />
                                            <asp:Button ID="ButFucionarAExpediente" runat="server" Text="Fusionar a expediente" class="btn btn-success col-md-4 col-sm-4 col-xs-12" CausesValidation="False" OnClick="btnFucionarAExpediteModal_Click"/>
                                        </div>
                                    </div>
	    ...
	    <FooterTemplate>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
                ...
                <div style="text-align:right;">
                    <br />&nbsp;
                    <asp:Button ID="btnAplicarHold" runat="server" CausesValidation="false" Text="Aplicar Hold" class="btn btn-warning" OnClick="btnAplicarHold_Click" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_pnlPopMotivosHold_TPCFm1_btnAplicarHold');"/>
                    <br />&nbsp;
		        </div>
                    </ContentTemplate>
            </asp:UpdatePanel>
	    ...
	    <FooterTemplate>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
                <ContentTemplate>
                    <div style="text-align:right;">
                        <br />&nbsp;
                        <asp:Button ID="btnAplicarSuspender" runat="server" CausesValidation="false" Text="Aplicar Suspensión" class="btn btn-warning"  OnClick="btnAplicarSuspender_Click" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_pnlPopMotivosSuspender_TPCFm1_btnAplicarSuspender');"/>
                        <br />&nbsp;
		            </div>
                </ContentTemplate>
            </asp:UpdatePanel>
	    ...
	    <FooterTemplate>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
                <ContentTemplate>
                    <div style="text-align:right;">
                        <br />&nbsp;
                        <asp:Button ID="btnAplicarRechazar" CausesValidation="false" runat="server" Text="Aplicar Rechazo" class="btn btn-warning" OnClick="btnAplicarRechazar_Click" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_pnlPopMotivosRechazar_TPCFm1_btnAplicarRechazar');"/>
                        <br />&nbsp;
		            </div>
                </ContentTemplate>
            </asp:UpdatePanel>
    ...
    <dx:ASPxPopupControl ID="pnlPopPausaTramite" 
	    ...
	    <FooterTemplate>
		    <div style="text-align:right;">
                <br />
                <asp:Button ID="btnPausaTramite" runat="server" Text="Pausar" CausesValidation="false" class="btn btn-warning" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_pnlPopPausaTramite_TPCFm1_btnPausaTramite'); pnlPopPausaTramite.Hide();" OnClick="btnCtrlPausarTramite_Click"/>
			    <br />&nbsp;
		    </div>
	    </FooterTemplate>
    </dx:ASPxPopupControl>
    ...
    <dx:ASPxPopupControl ID="pnlPopCancelar" runat="server" CloseAction="CloseButton" HeaderText="Motivos cancelación" ShowFooter="True" Theme="Aqua"  Width="350px" ClientInstanceName="pnlPopCancelar" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" FooterText="">
        ...
        <FooterTemplate>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
                ...
                <div style="text-align:right;">
                    <br />&nbsp;
                    <asp:Button ID="btnAplicarCancelar" runat="server" CausesValidation="false" Text="Aplicar Cancelación" class="btn btn-warning" OnClick="btnAplicarCancelar_Click" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_btnAplicarCancelar');"/>
                    <br />&nbsp;
		        </div>
                    </ContentTemplate>
            </asp:UpdatePanel>
