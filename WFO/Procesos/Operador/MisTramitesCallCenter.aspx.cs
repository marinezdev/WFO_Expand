...
{
    public partial class MisTramitesCallCenter : Utilerias.Comun
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                List<prop.TramitesCallCenter> Tramites = tramitesPromotoria.ListaTramitesCallCenter(manejo_sesion.Usuarios.IdUsuario);
        ...
        protected void rptTramite_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName.Equals("Consultar"))
            {
                ...
                //Response.Redirect("TramiteTarea.aspx?IdProceso=1&Procesable=" + IdTramite);
                Response.Redirect(EncripParametros("IdProceso=1,Procesable=" + IdTramite, "TramiteTarea.aspx").URL, true);
            }
        }
