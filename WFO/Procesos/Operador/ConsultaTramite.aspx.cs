...
namespace WFO.Procesos.Operador
{
    public partial class ConsultaTramite : Utilerias.Comun
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                string script = "";
                script = "window.location.href='Tramites.aspx'; ";
        ...
        private void PintaDatosTramite(int pIdTramite)
        {
            ...
            if (Tramite_a_Procesar.Count > 0)
            {
                ...
                {
                    if (datos.TipoServicio == "Nuevo Negocio")
                    {
                        LabelNumeroPoliza.Text = "Numero de Solicitud: ";
                        LabelNumeroPoliza2.Text = datos.NumeroOrden?.ToString() ?? "";
                    }
                    else
                    {
                        LabelNumeroPoliza.Text = "Numero de Poliza: ";
                        LabelNumeroPoliza2.Text = datos.IdSisLegados?.ToString() ?? "";
                    }
