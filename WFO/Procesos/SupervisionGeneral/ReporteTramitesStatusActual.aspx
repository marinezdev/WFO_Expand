...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <script>
        ...
        function resultadoBitacora(data) {
            ...
            var tabla = "<table id='InfomacionBitacora' class='table table-striped table-bordered jambo_table bulk_action' style='width:100%'>" +
                "<thead>" +
                "<tr>" +
        ...
        function resultado(data) {
            ...
            var tabla = "<table id='InfomacionMesas' class='table table-striped table-bordered jambo_table bulk_action' style='width:100%'>" +
                "<thead>" +
                "<tr>" +
                "<td></td>" +
                "<td>Fecha envió</td>" +
