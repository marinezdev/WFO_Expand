                            ...
                            <asp:UpdatePanel id="DatosTramiteInformacion" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <table border="0" style="width: 100%;">    
                                        ...
                                        <tr>
                                            <td style="background-color:#ddd; color:black; display:none; font-size:smaller; text-align:center; font-family:'Arial Rounded MT'">
                                                <asp:Label ID="InfoGMMoneda" runat="server" Font-Names="Britannic Bold" Font-Size="12px"  Visible="True" Font-Bold="true" ></asp:Label>
                                            </td>
                                            <td colspan="2" style="background-color:#ddd; display:none; color:black; font-size:smaller; text-align:center; font-family:'Arial Rounded MT'">
                                        ...
                                        <tr>
                                            ...
                                            <td style="background-color:#ddd; display:none; color:black; font-size:smaller; text-align:center; font-family:'Arial Rounded MT'">
