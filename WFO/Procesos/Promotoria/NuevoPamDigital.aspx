<%@ Page Title="" Language="C#" MasterPageFile="~/Utilerias/Site.Master" AutoEventWireup="true" CodeBehind="NuevoPamDigital.aspx.cs" Inherits="WFO.Procesos.Promotoria.NuevoPamDigital" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    ...
    <script>
        ...
        function AlertaNumeroPoliza() {
            new PNotify({
                title: 'Número de Póliza!',
                text: 'El número de póliza es requerido (con formato de 6 dígitos).',
                type: 'error',
                styling: 'bootstrap3'
            });
        }
                    ...
                    <div class="container">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                            <div class="card">
                                ...
                                <h2><small style="color:#007CC3"> TRAMITE NUEVO - EXPAND DIGITAL   </small></h2>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <asp:Label runat="server" ID="lblNumPolizaSolicitud" Text="" Font-Bold="True" class="control-label col-md-4 col-sm-4 col-xs-12"></asp:Label>
                                            <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                                                <asp:TextBox ID="textNumeroOrden" runat="server" MaxLength="6" AutoPostBack="false" class="form-control" autocomplete="off" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <asp:Panel ID="pnlPrima" runat="server" Visible="true">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator3" controltovalidate="txtPrimaTotal" ForeColor="Crimson" errormessage="*" Font-Size="16px"/>
                                                </div>
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator5" controltovalidate="txtPrimaExcedente" ForeColor="Crimson" errormessage="*" Font-Size="16px"/>
                                                </div>
                                            </asp:Panel>
                                        </div>
