...
{
    public partial class NuevoPAMPRO99 : Utilerias.Comun
    {
        ...
        protected void LisTipoServicio_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    //lblNumPolizaSolicitud.Text = "* Número de solicitud <br/><small>( 6 últimos dígitos)</small>";
            txtTelefono1.Text = "";
            txtTelefono2.Text = "";
        ...
        protected void BtnContinuar_Click(object sender, EventArgs e)
        {
            ...
            if (textNumeroOrden.Text.Trim().Length != 20)
            {
                script = "AlertaFDC();";
            ...
            if (LisTipoServicio.SelectedValue.ToString() == "1")
            {
        ...
        private prop.TramiteN1 recuperaCaptura()
        {
            ...
            NuevoTramite.IdTipoTramite = 4;   // Definicion tipo de tramite. 1 PAM Digital, 4 PAM Pro99
